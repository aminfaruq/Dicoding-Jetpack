...
object DataDummy {
    ...
    fun generateDummyMovie(): ArrayList<MovieEntity> {
        ...
        movies.add(
            MovieEntity(
                ...
                "${imageUrl}ww5aGS5H2tUtckxFFNOJE2790S7.jpg"
            )
        )
    ...
    fun getMovie(movieId: String): MovieEntity? {
        for (i in 0 until generateDummyMovie().size) {
            val entity = generateDummyMovie()[i]
            if (entity.movieId.equals(movieId)) {
                return entity
            }
        }
        return null
    ...
    fun getTvShow(tvShowId: String): TvShowEntity? {
        for (i in 0 until generateDummyTvShow().size) {
            val entity = generateDummyTvShow()[i]
            if (entity.tvId.equals(tvShowId)) {
                return entity
            }
        }
        return null
